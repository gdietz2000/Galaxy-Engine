...
namespace Galaxy
{
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		GX_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
	...
	void OpenGLFramebuffer::Resize(uint32_t width, uint32_t height)
	{
		...
		{
			GX_CORE_WARN("Attempted to resize framebuffer to {0}, {1}", width, height);
			return;
		}
